...
var _reactTransitionGroup = __webpack_require__(56);
...
var Item = function Item(_ref) {
  var vehicle = _ref.vehicle,
      ...
      id = _ref.id,
      frame_no = _ref.frame_no,
      engine_no = _ref.engine_no,
      user_phone = _ref.user_phone,
      clickHandle = _ref.clickHandle;

  var href = '/portal/peccancy/userPeccancy.do?vehicleNo=' + vehicle + '&engineNo=' + engine_no + '&userPhone=' + user_phone;
  return _react2.default.createElement(
    'a',
    { className: 'item', href: href },
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { className: 'order__icon', src: '/portal/images/icon/car.png' }),
          vehicle
        ),
        _react2.default.createElement(
          'div',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { className: 'button-tag button-xx' },
          '\u67E5\u770B\u8FDD\u7AE0\u8BB0\u5F55'
        )
      )
    )
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.state = { list: [], loadFlag: false };

    _this.remove = _this.remove.bind(_this);
    _this.delHandle = _this.delHandle.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function initLoad() {
      ...
      (0, _api.getVehicleList)().then(function (res) {
        var data = res.data;

        if (data && data.length) {
          _this2.setState({ list: data, loadFlag: true });
        } else {
          _this2.setState({ loadFlag: true });
        }
      });
    }
  }, {
    ...
    value: function delHandle(e) {
      ...
      weui.confirm('确定删除吗？', function () {
        var loading = weui.loading('处理中...');
        (0, _api.delVehicleById)(id).then(function (res) {
          var data = res.data;
      ...
      var items = this.state.list.map(function (item) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Item, {
            ...
            clickHandle: _this4.delHandle,
            vehicle_type: (0, _util.getVehicleTypeAsText)(item.vehicle_type),
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'main',
              null,
              _react2.default.createElement(SkeletonPlaceholder, null)
            ),
            _react2.default.createElement(
              'div',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { className: 'button', href: '/portal/peccancy/addVehicle.do' },
                  '\u6DFB\u52A0\u8F66\u8F86'
                )
              )
            )
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            items.length ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'placeholder-empty__text' },
                '\u6682\u65E0\u6570\u636E'
              )
            )
          ),
...
var _ReplaceTransition = _interopRequireDefault(__webpack_require__(66));
...
var _addClass = _interopRequireDefault(__webpack_require__(62));
